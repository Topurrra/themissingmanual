...
phase: 7
summary: "Turn raw exceptions into correct HTTP responses: per-controller @ExceptionHandler, app-wide @RestControllerAdvice, the right status code for each failure, and one consistent error body with Spring's ProblemDetail."
