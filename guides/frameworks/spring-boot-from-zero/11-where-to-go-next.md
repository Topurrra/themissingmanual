...
phase: 11
summary: "You can build a layered, tested, secured REST API and deploy it. Clear signposts to where Spring goes from here - microservices, reactive, messaging - plus what to build."
