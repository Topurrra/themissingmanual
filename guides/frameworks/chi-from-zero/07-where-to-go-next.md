...
guide: "chi-from-zero"
phase: 7
summary: "Look at what you can build now, see plainly where chi sits next to Gin, Echo, and the improved Go 1.22 net/http mux, add a real database, and take the articles API home."
