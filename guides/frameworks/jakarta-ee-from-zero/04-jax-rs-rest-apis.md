...
phase: 4
summary: "Expose your CDI beans over HTTP the standard way: an @ApplicationPath bootstrap, @Path resource classes, the HTTP-method annotations, path and query params, JSON-B binding, and Response for correct status codes."
