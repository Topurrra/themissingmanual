...
phase: 10
summary: "You can build a fast Quarkus service and know why it's fast. Here's the production essentials - health, metrics, tracing, Kubernetes - the extension ecosystem, a clear-eyed look at the field, and what to build next."
