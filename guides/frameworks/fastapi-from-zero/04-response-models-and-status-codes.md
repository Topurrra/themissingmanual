...
phase: 4
summary: "Shape what your endpoints return with response_model, split input from output models so clients can't set or see internal fields, and return correct HTTP status codes including clean 404s via HTTPException."
