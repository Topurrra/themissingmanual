...
phase: 2
summary: "How to evolve an API without breaking clients: prefer additive changes, and when you must break, version (URL /v2/ vs header), run versions in parallel, and deprecate on a clear timeline with real communication - with the real trade-offs of each approach."
