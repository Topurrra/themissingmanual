...
phase: 0
summary: "What gRPC actually is - a contract-first way for internal services to call each other fast - how the .proto file, code generation, and HTTP/2 streaming fit together, and the real trade-offs versus REST and GraphQL."
