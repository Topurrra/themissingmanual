...
const DEFS: &[Def] = &[
    ...
    Def { slug: "frameworks", name: "Frameworks & Libraries", icon: "ti-stack-2", blurb: "Django, FastAPI, Spring Boot, and friends - the big backend frameworks and libraries, each tied to its language." },
